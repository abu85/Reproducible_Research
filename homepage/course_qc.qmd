...
If you want to work with this data, make a symbolic link to the data, do this from within a subdirectory called `rnaseq/data`(or something similar). You want to avoid mingling your data with the analyses:
...
```{.bash}
repbio26/common_data/metagenomics
```
