...
To use the config file with nextflow you need to add our compute project under `project`, on line 6. Use single quotes, as seen in the other entries in the file. 
